...
> **Currently parked:** `sooks-saga-scroll-07302026-1.html` — Build
> `07302026.1` (2026-07-30). Retain set is **2 files**: the 2 most recent
> overall (`-07302026-1`, 07-30 + `-07292026-8`, 07-29). The most-recent
> previous-day build (`-07292026-8`, 07-29) IS the second-most-recent overall,
> so the cross-day anchor and the newest-pair slot coincide — the retain set is
> just those 2 (no backfill).
> Pruned this park (moved to `_to_delete/`): `-07292026-7`, `-07272026-7`.
...
## Files
- `sooks-saga-scroll-07302026-1.html` — the live build. Open in any
