...
> **Currently parked:** `sooks-saga-scroll-07262026-1.html` — Build
> `07262026.1` (2026-07-26). Retain set is **2 files**: the 2 most recent
> overall (`-07262026-1`, 07-26; `-07252026-4`, 07-25) — and because
> `-07252026-4` is also the most-recent previous-day build, it doubles as the
> cross-day rollback anchor, so the set is 2 (the overlap rule: don't backfill).
> Pruned this park: `sooks-saga-scroll-07252026-3.html` and
> `sooks-saga-scroll-07242026-1.html` → `_to_delete/` (untracked; git records
> the tracked paths as deleted). **Roster & progress-bar visual pass (Build
> 07262026.1, still v14, no schema change):** four UI changes. (1) **Reaper bars
...
## Files
- `sooks-saga-scroll-07262026-1.html` — the live build. Open in any
...
> currently `Build 07262026.1`. **Live-data note (important for future content
