...
> **Currently parked:** `sooks-saga-scroll-07262026-3.html` — Build
> `07262026.3` (2026-07-26). Retain set is **3 files**: the 2 most recent
> overall (`-07262026-3` + `-07262026-2`, both 07-26) PLUS the most-recent
> previous-day build (`-07252026-4`, 07-25) as the cross-day rollback anchor.
> Pruned this park: `sooks-saga-scroll-07262026-1.html` → `_to_delete/`
> (untracked; git records the tracked path as deleted). **Completed-look polish
> (Build 07262026.3, CSS-only, still v14, no schema change):** (1) **Completed
...
## Files
- `sooks-saga-scroll-07262026-3.html` — the live build. Open in any
...
> currently `Build 07262026.3`. **Live-data note (important for future content
