...
> **Currently parked:** `sooks-saga-scroll-07262026-2.html` — Build
> `07262026.2` (2026-07-26). Retain set is **3 files**: the 2 most recent
> overall (`-07262026-2` + `-07262026-1`, both 07-26) PLUS the most-recent
> previous-day build (`-07252026-4`, 07-25) as the cross-day rollback anchor.
> Nothing pruned this park (only 3 build files exist, all retained). **Guild
> roster & LFM refinements (Build 07262026.2, still v14; adds two fields to the
> reference cache → `DDO_REF_EPOCH` 2→3, which forces a one-time refetch):**
...
## Files
- `sooks-saga-scroll-07262026-2.html` — the live build. Open in any
...
> currently `Build 07262026.2`. **Live-data note (important for future content
