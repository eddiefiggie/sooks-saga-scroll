...
> **Currently parked:** `sooks-saga-scroll-07262026-7.html` — Build
> `07262026.7` (2026-07-26). Retain set is **3 files**: the 2 most recent
> overall (`-07262026-7` + `-07262026-6`, both 07-26) PLUS the most-recent
> previous-day build (`-07252026-4`, 07-25) as the cross-day rollback anchor.
> Pruned this park: `sooks-saga-scroll-07262026-5.html`. **Group-status icons,
> unified reaper red, static Focus frame, LFM polish (Build 07262026.7, CSS + JS,
> still v14, no schema change):** (1) each guild-roster group status gets a
...
## Files
- `sooks-saga-scroll-07262026-7.html` — the live build. Open in any
...
> currently `Build 07262026.7`. **Live-data note (important for future content
